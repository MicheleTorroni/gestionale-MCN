...
public class Mysql {
	...
	public static Prodotto getTopOrdinato(String codiceTappeto) throws NumberFormatException, ClassNotFoundException, SQLException {
		return MysqlGet.getTopOrdinato(codiceTappeto);
	}
	
	public static Prodotto getBaseOrdinata(String codiceTappeto) throws NumberFormatException, ClassNotFoundException, SQLException {
		return MysqlGet.getBaseOrdinata(codiceTappeto);
	}
	
	public static Prodotto getAntinciampoOrdinato(String codiceTappeto) throws NumberFormatException, ClassNotFoundException, SQLException {
		return MysqlGet.getAntinciampoOrdinato(codiceTappeto);
	}
	
	public static Prodotto getTelaioOrdinato(String codiceInsegna) throws NumberFormatException, ClassNotFoundException, SQLException {
		return MysqlGet.getTelaioOrdinato(codiceInsegna);
	}
	
	public static Prodotto getNeonOrdinato(String codiceInsegna) throws NumberFormatException, ClassNotFoundException, SQLException {
		return MysqlGet.getNeonOrdinato(codiceInsegna);
	}
	
	public static Prodotto getLedOrdinato(String codiceInsegna) throws NumberFormatException, ClassNotFoundException, SQLException {
		return MysqlGet.getLedOrdinato(codiceInsegna);
	}
